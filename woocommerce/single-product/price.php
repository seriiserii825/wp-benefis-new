...
////    vardump($available_variations);
////    vardump($available_variations[0]['price_html']);
////    vardump($available_variations[1]['price_html']);
//
//	//цена продажи (распродажи) первой вариации
////	$adult_price = $available_variations[0]['price_html'];
//
